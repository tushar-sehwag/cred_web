...
const MobileScroll = () => {
  ...
  return (
    <div className="ms917MobileScroll flex max-width">
      <div className="ms917FullScreenWrapper">
        {scrollData.map((screen, i) => (
          <div className="ms917FullScreen">
            <ScreenText screen={screen} setCurrentImg={setCurrentImg} i={i} />
          </div>
        ))}
      </div>
      <div className="ms917MobileMockupWrapper hide-for-mobile">
